...
def get_args():
    ...
    parser.add_argument('--train_batch', type=int, default=64, help='input batch size for train')
...
def main():
    ...
    for epoch in range(start_epoch, args.nEpochs + 1):
        ...
        for i, sample_batched in enumerate(trainloader):
            ...
            print("epoch(%d), i(%d): loss=%f, L_alpha=%f, L_composition=%f, L_cross=%f" % (epoch, i, loss.item(), L_alpha.item(), L_composition.item(), L_cross.item()))
